...
export default function Languages() {
    return (
    <section className="max-w-6xl mx-auto px-6 py-12 md:py-20 border-t border-[var(--border)]" aria-label="Languages">
      <div className="grid md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
          {data.languages.map((item, index) => (
            <article key={index} className="premium-card rounded-none shadow-none hover:shadow-none hover:translate-y-0 border-none border-l-2 border-[var(--border)] hover:border-[var(--accent)] transition-all px-8 py-4">
