...
export default function About() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-12 md:py-20" id="about">
      <div className="grid-layout">
        ...
        <div className="md:col-span-8 flex flex-col gap-6 md:gap-8">
          ...
          <div className="h-px bg-[var(--border)] w-16 md:w-24"></div>
          <div className="flex flex-col gap-5 md:gap-6 text-base md:text-lg text-[var(--text-muted)] leading-relaxed font-light">
            <p>
              {data.about}
            </p>
            <p>
